// Inject a value into a single component of a vec2<f32> buffer.
...
//   component: which component to modify (0=x, 1=y)
...
@group(0) @binding(1) var<storage, read>       target:     array<vec2<f32>>;
@group(0) @binding(2) var<storage, read_write> target_out: array<vec2<f32>>;
