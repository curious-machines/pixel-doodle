//! Standalone example: render multiple filled shapes via tile-based vector rasterization.
//!
//! Tests multi-path compositing (painter's algorithm), winding number correctness
//! (donut hole), and bezier curve flattening.
//!
...
impl ApplicationHandler for VectorApp {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let win_attrs = Window::default_attributes()
            .with_title("Vector Scene — Tile Rasterization")
        ...
        // Generate test scene: multi-shape with overlapping paths
        let scene = vector::test_scene(TOLERANCE, TILE_SIZE, WIDTH, HEIGHT);
